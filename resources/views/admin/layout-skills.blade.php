...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/skills.js') }}"></script>
@endsection
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">{{ __('Skills') }}</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.skills.add') }}" method="POST">
                                    @csrf
                                ...
                                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_skills">
                                    <thead>
                                    <tr>
                                        <th title="Field #1">#</th>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.skills.edit') }}" method="POST">
                        @csrf
