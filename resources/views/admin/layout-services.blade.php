                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="javascript:;" class="text-muted">{{ __('Services') }}</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('Sidebar Text') }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="txt_highlight">{{ __('Highlight text in Content') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                                   placeholder="{{ __('Highlight text in Content') }}" id="txt_highlight"
