...
@section('js_after')
    <script src="{{ asset('_admin/js/pages/layout/work.js') }}"></script>
@endsection
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('admin.layout.work.add') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div id="add_skills" class="p-8 border-primary border-1" style="border-style: dotted;">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-md-3">
                                                <label for="txt_order">Category:</label>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="{{ route('admin.layout.work.edit') }}" method="POST">
                        @csrf
